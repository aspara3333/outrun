...
static PyObject *impl_numpy$core$_methods$$$function__12__mean(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    branch_no_5:;
    {
        ...
        tmp_res = HAS_ATTR_BOOL2(tmp_expression_value_15, mod_consts[25]);
        if (tmp_res == -1) {
            assert(ERROR_OCCURRED());
...
static PyObject *impl_numpy$core$_methods$$$function__13__var(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    branch_no_4:;
    {
        ...
        tmp_res = HAS_ATTR_BOOL2(tmp_expression_value_13, mod_consts[25]);
        if (tmp_res == -1) {
            assert(ERROR_OCCURRED());
    ...
    branch_no_12:;
    {
        ...
        tmp_res = HAS_ATTR_BOOL2(tmp_expression_value_38, mod_consts[25]);
        if (tmp_res == -1) {
            assert(ERROR_OCCURRED());
...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
        ...
        if (PyModule_Check(tmp_import_name_from_2)) {
            ...
            tmp_assign_source_6 = IMPORT_NAME_FROM_MODULE(tmp_import_name_from_2, mod_consts[108]);
        }
    ...
    }
    {
        ...
        if (PyModule_Check(tmp_import_name_from_3)) {
            ...
            tmp_assign_source_7 = IMPORT_NAME_FROM_MODULE(tmp_import_name_from_3, mod_consts[110]);
        }
    ...
    }
    {
        ...
        if (PyModule_Check(tmp_import_name_from_8)) {
            ...
            tmp_assign_source_12 = IMPORT_NAME_FROM_MODULE(tmp_import_name_from_8, mod_consts[120]);
        }
